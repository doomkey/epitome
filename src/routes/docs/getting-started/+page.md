...
Note that if a section has no entry, it will be hidden from the resume. However, you can [hide a section](/docs/customization/sections/) without deleting all of the entries of that section.
